...
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '公司管理',(select menu_id from menu where menu_name = '菜单管理'),'/mainManage/companyManage','heart-o',1,now(),now(),1,1;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '角色管理',(select menu_id from menu where menu_name = '菜单管理'),'/mainManage/roleManage','heart-o',1,now(),now(),1,1;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '用户管理',(select menu_id from menu where menu_name = '菜单管理'),'/mainManage/rolesManage','heart-o',1,now(),now(),1,1;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '项目申请',(select menu_id from menu where menu_name = '项目管理'),'/agreementManage','heart-o',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '协议申请管理',(select menu_id from menu where menu_name = '协议管理'),'/agreementManage','heart-o',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估申请',(select menu_id from menu where menu_name = '评估管理'),'/evaluationApply','heart-o',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估工单管理',(select menu_id from menu where menu_name = '评估管理'),'/evaluationManage','heart-o',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务项目配置',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/projectConfig','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务包配置',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/serviceConfig','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务计划制定',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/planMake','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务计划查看',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/planView','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务计划执行',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/planPerform','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务机构变更',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/changeInstitution','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务计划变更',(select menu_id from menu where menu_name = '服务管理'),'/serviceManage/changePlan','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '入院登记',(select menu_id from menu where menu_name = '出入院管理'),'/hospitalManage/inHospital','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '出院管理',(select menu_id from menu where menu_name = '出入院管理'),'/hospitalManage/outHospital','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估费用结算',(select menu_id from menu where menu_name = '评估结算管理'),'/evaluateSettlement/settlement','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '生成评估费用结算单',(select menu_id from menu where menu_name = '评估结算管理'),'/evaluateSettlement/listing','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '服务费用结算',(select menu_id from menu where menu_name = '服务结算管理'),'/serviceSettlement/settlement','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '生成护理费用结算单',(select menu_id from menu where menu_name = '服务结算管理'),'/serviceSettlement/listing','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '参保人信息维护',(select menu_id from menu where menu_name = '参保人管理'),'/peopleManage/infoMaintenance','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '参保人个人帐户',(select menu_id from menu where menu_name = '参保人管理'),'/peopleManage/privateAccounts','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '参保人黑名单',(select menu_id from menu where menu_name = '参保人管理'),'/peopleManage/blacklist','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估机构协议配置',(select menu_id from menu where menu_name = '两定机构协议管理'),'/protocolConfig/evaluateConfig','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '护理机构协议配置',(select menu_id from menu where menu_name = '两定机构协议管理'),'/protocolConfig/serviceConfig','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估机构配置',(select menu_id from menu where menu_name = '评估机构管理'),'/evaluationInstitutionsConfig/institution','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估人员配置',(select menu_id from menu where menu_name = '评估机构管理'),'/evaluationInstitutionsConfig/workers','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '护理机构配置',(select menu_id from menu where menu_name = '服务机构管理'),'/serviceInstitutionsConfig/institution','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '护理人员配置',(select menu_id from menu where menu_name = '服务机构管理'),'/serviceInstitutionsConfig/workers','database',1,now(),now(),1,1 ;
...
Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估机构质量分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '护理机构质量分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '参保人群分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估结果质量分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '评估费用分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '护理费用分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '基金使用率与结余分析',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;

Insert into `ltc_security`.`menu`
(`menu_name`,`parent_id`,`url`,`icon`,`active`,`created_at`,`modified_at`,`created_by`,`modified_by`)
  select '费用预警配置',(select menu_id from menu where menu_name = '大数据管理'),'user','database',1,now(),now(),1,1 ;
